      ...
      return (
        ...
        >
          ...
          <div className="w-full">
            <Button variant="outline" className="w-full py-6" onClick={() => handleOAuthLogin('google')} disabled={isLoading}>Sign in with Google <GoogleIcon className="h-5 w-5 ml-5" /></Button>
          </div>
