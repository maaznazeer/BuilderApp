...
const NavigationMenuContent = React.forwardRef(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.Content
    ...
    className={cn(
      ...
      "bg-white dark:bg-gray-950 text-gray-950 dark:text-gray-50", // Added dark mode support
      className
    )}
    {...props}
  />
  ...
  <div className={cn("absolute left-0 top-full flex justify-center")}>
    <NavigationMenuPrimitive.Viewport
      className={cn(
        ...
        "dark:border-slate-800 dark:bg-slate-950 dark:text-slate-50", // Added dark mode support
        className
      )}
      ref={ref}
      {...props}
